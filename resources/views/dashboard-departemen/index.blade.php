    ...
    new Chart(ctx4, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [{
                    {
                        $mahasiswa - > jumlah_status_pkl['sudah_ambil']
                    }
                }, {
                    {
                        $mahasiswa - > jumlah_status_pkl['belum_ambil']
                    }
                }],
                fill: false
            }],
    ...
    new Chart(ctx5, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [{
                    {
                        $pkl - > jumlah_kelulusan['lulus'].
                        ','.$pkl - > jumlah_kelulusan['belum_lulus']
                    }
                }],
                fill: false
            }],
    ...
    new Chart(ctx6, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [{
                    {
                        $mahasiswa - > jumlah_status_skripsi['sudah_ambil'].
                        ','.$mahasiswa - > jumlah_status_skripsi['belum_ambil']
                    }
                }],
                fill: false
            }],
    ...
    new Chart(ctx7, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [{
                    {
                        $skripsi - > jumlah_kelulusan['lulus'].
                        ','.$skripsi - > jumlah_kelulusan['belum_lulus']
                    }
                }],
                fill: false
            }],
